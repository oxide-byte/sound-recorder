...
**Tests**: Include verification tasks for each user story. Automated tests are preferred;
manual verification is acceptable only for trivial changes and MUST be documented.
...
- [ ] T010 Define CLI input/output/error contract for core workflows
...
> **NOTE: Prefer automated tests; if scope is trivial, add a manual verification task
> with reproducible evidence instead.**
